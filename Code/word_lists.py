...
function_words = ['a','as','do','has','is','no','or','than','this','when',
    ...
    'are','can','had','into','my','only','such','thing','what', 'hence']
    
# 2 additional lists of words used by Mosteller & Wallace
...
additional_words2 =  ['about','choice','proper','according','common','kind','propriety','adversaries',
                      'danger','large','provision','after','decides','decided','deciding',
